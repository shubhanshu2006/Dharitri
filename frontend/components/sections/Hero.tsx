...
export function Hero() {
  return (
    <InfraBanner
      id="hero"
      as="section"
      className="section-scroll-anchor min-h-screen pt-6 text-black sm:pt-0"
      ...
      descriptionClassName="font-intern max-w-2xl text-lg font-semibold leading-relaxed text-black drop-shadow-[0_2px_8px_rgba(255,255,255,0.8)] sm:text-xl"
      contentClassName="sm:-translate-y-12"
      ...
      description="DHARITRI connects land, people, processes, and payments in one intelligent platform - making every acquisition traceable from proposal to possession."
    />
  );
}
