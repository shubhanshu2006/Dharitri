...
export const PROJECT_TYPE_LABELS: Record<ProjectType, string> = {
  ...
  [ProjectType.METRO]: "Metro",
  [ProjectType.AIRPORT]: "Airport",
  [ProjectType.PORT]: "Port",
  [ProjectType.INDUSTRIAL_CORRIDOR]: "Industrial Corridor",
  [ProjectType.SMART_CITY]: "Smart City",
  [ProjectType.AFFORDABLE_HOUSING]: "Affordable Housing",
  [ProjectType.IRRIGATION]: "Irrigation",
  [ProjectType.POWER_TRANSMISSION]: "Power Transmission",
  [ProjectType.MINING]: "Mining",
  [ProjectType.DEFENSE]: "Defense",
  [ProjectType.URBAN_DEVELOPMENT]: "Urban Development",
  [ProjectType.RURAL_DEVELOPMENT]: "Rural Development",
