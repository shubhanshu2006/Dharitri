...
export default function SignUpPage() {
  return (
    <main className="min-h-svh bg-[#eef4f1] p-3 sm:p-5 lg:p-6">
      <div className="mx-auto flex min-h-[calc(100svh-24px)] max-w-375 overflow-hidden rounded-[28px] bg-[#f8f6ef] shadow-[0_20px_80px_-30px_rgba(20,60,45,0.25)] sm:min-h-[calc(100svh-40px)] lg:h-[calc(100svh-48px)]">
        {/* =====================================================
            LEFT — DHARITRI VISUAL
        ====================================================== */}
        ...
        {/* =====================================================
            RIGHT — SIGN UP
        ====================================================== */}
        <section className="relative flex min-h-[calc(100svh-24px)] w-full items-start justify-center overflow-hidden rounded-r-[28px] bg-[#faf9f4] px-6 py-8 sm:px-10 sm:py-10 lg:min-h-0 lg:w-[48%] lg:px-10 lg:py-3 xl:px-14">
          ...
          <div className="w-full max-w-107.5 lg:zoom-[0.78]">
            ...
            <div className="mb-8">
              ...
              <p className="mt-3 max-w-sm text-base leading-relaxed text-slate-600">
                Set up your workspace and start tracking land acquisition.
              </p>
            </div>
            ...
            <SignUp
              appearance={{
                ...
                elements: {
                  rootBox: "w-full",
                  card: "w-full min-w-0 overflow-hidden rounded-[24px] bg-transparent shadow-none border border-slate-200 p-0",
